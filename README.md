...
This repository is an assignment for Polytechnic School's 2025-2026 
...
5. Use `cd` to move back to the main project directory, and use use `git` to add the new directory and its file to the project, and commit this working version of the project (to your local copy of the fork).
